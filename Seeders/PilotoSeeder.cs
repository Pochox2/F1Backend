        ...
        public static void Seed(ApplicationDbContext context)
        {
            if (!context.Pilotos.Any())
            {
                context.Pilotos.AddRange(
                    ...
                    new Piloto { Id = 4, Nombre = "Lewis Hamilton", Pais = "Reino Unido", Numero = 44, Edad = 40, EscuderiaId = 3, Seed = true, ImagenUrl = "https://i.pinimg.com/564x/1d/57/4b/1d574b563a4e69f332366a6610a0d6e5.jpg" },
                    ...
                    new Piloto { Id = 9, Nombre = "Fernando Alonso", Pais = "España", Numero = 14, Edad = 43, EscuderiaId = 6, Seed = true, ImagenUrl = "https://e7.pngegg.com/pngimages/22/347/png-clipart-of-man-fernando-alonso-face-celebrities-sports-celebrities.png" },
                    ...
                    new Piloto { Id = 12, Nombre = "Franco Colapinto", Pais = "Argentina", Numero = 43, Edad = 21, EscuderiaId = 1, Seed = true, ImagenUrl = "https://d22fxaf9t8d39k.cloudfront.net/a814c4526071b091db75eaf10c65786499b38b7ccc5e4a801f43e434d1835629296785.png" },
